...
<header>
    <nav class="navbar">
        ...
        <ul class="menu">
            ...
            <li><a class="active" href="/goResource.do">资源区</a></li>
        </ul>
    </nav>
...
<div id="container">
    <div id="book-container">
        <h3 class="book-title"><a href="#">| 所有发布的资源</a></h3>
        <ul class="book-lists">
            <c:forEach items="${resourceList}" var="resource" varStatus="rscStatus">
                <li class="book-list">
                    <a href="/goResource.do}" class="book-pic" target="_blank">
                        <img src="<%=request.getContextPath()%>/img/resource/img/${resource.getImage()}">
                    </a>
                    <a href="#" class="book-info">
                        <h5 class="book-name">${resource.getName()}</h5>
                        <span class="book-detail">${resource.getDescription()}</span>
                    </a>
                    <span class="book-price" ResourceId="${resource.id}">上传人：${resource.getUserId()}
						<a href="#" class="book-buy">删除资源</a>
                </span>
                </li>
            </c:forEach>
...
<script type="text/javascript">
    ...
    $("span.book-price").on("click",function(){
        var $this = $(this);
        var Mydata="id="+$this.attr("ResourceId");
        $.ajax({
            type:"POST",
            url:"/admin/goadminresource",
            data:Mydata,
            success:function(result){
                alert("删除成功");
                window.location.href="/admin/goadminresource";
            },
