...
<div class="container">
    <form enctype="multipart/form-data" id="bookForm" class="upload-form">
        ...
        <p>
            ...
            书&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" name="name" placeholder="请输入书籍的名称">
        </p>
        <p>
            <span class="author-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者：<input type="text" name="author" placeholder="请输入作者">
        </p>
        <p>
            <span class="name-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        ...
        <p>
            ...
            书&nbsp;本&nbsp;&nbsp;原&nbsp;价：<input type="text" name="originalPrice" onkeyup="value=value.replace(/[^\d\.]/g,'')" placeholder="请输入整数或小数">
        </p>
        <p>
            <span class="price-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            书&nbsp;本&nbsp;&nbsp;售&nbsp;价：<input type="text" name="price"   onkeyup="value=value.replace(/[^\d\.]/g,'')" placeholder="请输入整数或小数">
        </p>
        <p>
        ...
        <p>
            ...
            书&nbsp;本&nbsp;&nbsp;品&nbsp;相：<input type="text" name="degree" onkeyup="value=value.replace(/[^\d\.]/g,'')" placeholder="请输入整数或小数">
        </p>
        <p>
